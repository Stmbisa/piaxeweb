...
const mockPaymentLinks: PaymentLink[] = [
    {
        ...
        amount: 75000,
        currency: 'UGX',
        url: 'https://pay.gopiaxis.com/link/coffee-subscription',
        isActive: true,
    ...
    },
    {
        ...
        amount: 0,
        currency: 'UGX',
        url: 'https://pay.gopiaxis.com/link/school-donation',
        isActive: true,
    ...
    },
    {
        ...
        amount: 150000,
        currency: 'UGX',
        url: 'https://pay.gopiaxis.com/link/tech-conference',
        isActive: false,
...
const mockSharedCarts: SharedCart[] = [
    {
        ...
        url: 'https://pay.gopiaxis.com/cart/office-lunch-friday',
        isActive: true,
        target: 130000,
    ...
    },
    {
        ...
        url: 'https://pay.gopiaxis.com/cart/john-birthday-gift',
        isActive: true,
        target: 300000,
