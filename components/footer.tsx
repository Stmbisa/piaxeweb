    ...
    <footer className="border-t bg-muted/40" role="contentinfo">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <Image src="/images/logo.png" alt="Piaxe Logo" width={24} height={24} className="w-6 h-6" />
              <span className="font-bold text-lg text-primary">Piaxe</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#consumers" className="text-muted-foreground hover:text-foreground text-sm">
                  For Consumers
                </Link>
              </li>
              <li>
                <Link href="#sme" className="text-muted-foreground hover:text-foreground text-sm">
                  For SMEs
                </Link>
              </li>
              <li>
                <Link href="#developers" className="text-muted-foreground hover:text-foreground text-sm">
                  API Documentation
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#help" className="text-muted-foreground hover:text-foreground text-sm">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="#security" className="text-muted-foreground hover:text-foreground text-sm">
                  Security
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">© 2025 Piaxe. All rights reserved.</p>
