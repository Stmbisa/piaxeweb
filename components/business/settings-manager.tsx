...
export function SettingsManager() {
    ...
    const [apiKey] = useState('pk_live_51K3...' + Math.random().toString(36).substr(2, 24))
                ...
                <Card>
                    <CardContent className="p-6">
                        <div className="flex items-center gap-4">
                            <label htmlFor="store-select" className="font-medium">Configure Store:</label>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Switch
                                            ...
                                            checked={securitySettings.password_requirements.require_lowercase}
                                            onCheckedChange={(checked) => setSecuritySettings(prev => ({
                                                ...prev,
                                                password_requirements: {
                                                    ...prev.password_requirements,
                        ...
                        <CardContent className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-between p-3 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Mobile Money & Cards</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Order & Payment Alerts</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">External inventory systems</p>
                                            </div>
                                        </div>
                            ...
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <p className="text-sm text-blue-700 mb-3">
                                    Learn how to integrate with our APIs to build custom solutions.
                                </p>
