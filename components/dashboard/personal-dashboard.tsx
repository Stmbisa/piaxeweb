...
export function PersonalDashboard() {
  ...
  const [dashboardType, setDashboardType] = useState<
    "loading" | "personal" | "business" | "combined"
  >("loading");
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-12 animate-fade-in">
            ...
            >
              <RefreshCw
                className={`w-5 h-5 ${
                  walletsLoading || balanceLoading || transactionsLoading
                    ? "animate-spin"
                    : ""
                }`}
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
            {/* Primary Balance */}
            <div className="glass-card-primary animate-glass-appear [animation-delay:100ms]">
            ...
            {/* Total Wallets */}
            <div className="glass-card animate-glass-appear [animation-delay:200ms]">
              <div className="flex items-center justify-between mb-4">
            ...
            {/* Quick Actions */}
            <div className="glass-card animate-glass-appear md:col-span-2 relative z-10 [animation-delay:300ms]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            {/* Wallets List */}
            <div className="glass-card animate-glass-appear [animation-delay:400ms]">
              <h3 className="font-semibold mb-4 text-foreground">
                Your Wallets
              </h3>
              {walletsLoading ? (
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-3 bg-muted/20 rounded-lg animate-pulse"
                    >
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-xs">
                    Wallets will appear here once created
                  </p>
                </div>
              )}
            </div>
            ...
            {/* Recent Transactions */}
            <div className="glass-card animate-glass-appear [animation-delay:500ms]">
              <h3 className="font-semibold mb-4 text-foreground">
                Recent Transactions
              </h3>
              {transactionsLoading ? (
          ...
          <div className="mt-8 sm:mt-12 glass-card-large animate-glass-appear [animation-delay:600ms]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Access advanced features like store management, inventory
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Integrate Piaxe's payment system into your applications with
                  our developer API
                </p>
