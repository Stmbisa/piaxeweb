...
export function SecurityFeatures() {
  return (
    <section className="py-2 sm:py-16 bg-gradient-to-br from-background via-background/80 to-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-1 sm:px-4 relative z-10">
        <div className="text-center mb-2 sm:mb-12 animate-glass-appear">
          <h2 className="text-base sm:text-3xl font-bold tracking-tight mb-1 sm:mb-4">Never be scammed again</h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0.5 sm:gap-4 lg:gap-6">
          <div className="glass-card text-center p-1.5 sm:p-4 animate-glass-appear" style={{ animationDelay: "0.1s" }}>
            <div className="glass-icon-button w-5 h-5 sm:w-12 sm:h-12 mx-auto mb-0.5 sm:mb-4">
              <Shield className="w-2.5 h-2.5 sm:w-6 sm:h-6 text-primary" />
            </div>
          ...
          <div className="glass-card text-center p-1.5 sm:p-4 animate-glass-appear" style={{ animationDelay: "0.2s" }}>
            <div className="glass-icon-button w-5 h-5 sm:w-12 sm:h-12 mx-auto mb-0.5 sm:mb-4">
              <Lock className="w-2.5 h-2.5 sm:w-6 sm:h-6 text-primary" />
            </div>
          ...
          <div className="glass-card text-center p-1.5 sm:p-4 animate-glass-appear" style={{ animationDelay: "0.3s" }}>
            <div className="glass-icon-button w-5 h-5 sm:w-12 sm:h-12 mx-auto mb-0.5 sm:mb-4">
              <Eye className="w-2.5 h-2.5 sm:w-6 sm:h-6 text-primary" />
            </div>
          ...
          <div className="glass-card text-center p-1.5 sm:p-4 animate-glass-appear" style={{ animationDelay: "0.4s" }}>
            <div className="glass-icon-button w-5 h-5 sm:w-12 sm:h-12 mx-auto mb-0.5 sm:mb-4">
              <CheckCircle className="w-2.5 h-2.5 sm:w-6 sm:h-6 text-primary" />
            </div>
