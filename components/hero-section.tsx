...
export function HeroSection() {
  return (
    <section className="relative py-10 sm:py-12 lg:py-20 bg-gradient-to-br from-background via-purple-50/20 to-blue-50/30 dark:from-slate-900 dark:via-purple-950/20 dark:to-blue-950/30 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 pt-3 sm:pt-4">
            <Button size="lg" className="rounded-full px-6 sm:px-8 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300">
              Download App
            </Button>
            <Button size="lg" variant="outline" className="rounded-full px-6 sm:px-8 border-primary/20 hover:border-primary hover:bg-primary/5 transition-all duration-300">
              Learn More
            </Button>
          </div>
