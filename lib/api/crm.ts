...
class CRMAPI {
  ...
  // Customer Management
  async createCustomer(token: string, customerData: CustomerCreate): Promise<Customer> {
    try {
  ...
  async getCustomers(token: string, params?: {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/crm/customers?${queryParams}`, {
        method: 'GET',
        headers: this.getHeaders(token),
      })
  ...
  async updateCustomer(token: string, customerId: string, customerData: CustomerUpdate): Promise<Customer> {
    try {
      const response = await fetch(`${API_BASE_URL}/crm/customers/${customerId}`, {
        method: 'PUT',
        headers: this.getHeaders(token),
  ...
  // Customer Segments
  async createSegment(token: string, segmentData: SegmentCreate): Promise<CustomerSegment> {
    try {
  ...
  async getSegmentCustomers(token: string, segmentId: string, params?: { page?: number, limit?: number }): Promise<{ customers: Customer[], total: number }> {
    try {
      const queryParams = new URLSearchParams()
      if (params?.page) queryParams.append('page', params.page.toString())
      if (params?.limit) queryParams.append('limit', params.limit.toString())

      const response = await fetch(`${API_BASE_URL}/crm/segments/${segmentId}/customers?${queryParams}`, {
        method: 'GET',
        headers: this.getHeaders(token),
      })
  ...
  async getCampaigns(token: string, params?: {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/crm/campaigns?${queryParams}`, {
        method: 'GET',
        headers: this.getHeaders(token),
      })
  ...
  async updateCampaign(token: string, campaignId: string, campaignData: CampaignUpdate): Promise<Campaign> {
    try {
      const response = await fetch(`${API_BASE_URL}/crm/campaigns/${campaignId}`, {
        method: 'PUT',
        headers: this.getHeaders(token),
  ...
  async sendCampaign(token: string, campaignId: string): Promise<{ message: string, sent_count: number }> {
    try {
      const response = await fetch(`${API_BASE_URL}/crm/campaigns/${campaignId}/send`, {
        method: 'POST',
        headers: this.getHeaders(token),
      })
  ...
  // Analytics
  async getCustomerAnalytics(token: string, params?: {
    start_date?: string
    end_date?: string
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/crm/analytics/customers?${queryParams}`, {
        method: 'GET',
        headers: this.getHeaders(token),
      })
  ...
  async getCampaignAnalytics(token: string, params?: {
    start_date?: string
    end_date?: string
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/crm/analytics/campaigns?${queryParams}`, {
        method: 'GET',
        headers: this.getHeaders(token),
      })
