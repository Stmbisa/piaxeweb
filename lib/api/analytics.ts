...
class AnalyticsAPI {
  ...
  async getStoreAnalytics(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/analytics/stores/${storeId}?${queryParams}`,
        {
          method: "GET",
  ...
  async getPaymentAnalytics(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/analytics/payments?${queryParams}`,
        {
          method: "GET",
          headers: this.getHeaders(token),
          credentials: "include",
  ...
  async getMerchantAnalytics(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/analytics/merchant?${queryParams}`,
        {
          method: "GET",
          headers: this.getHeaders(token),
          credentials: "include",
  ...
  async getCategoryAnalytics(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/analytics/stores/${storeId}/categories?${queryParams}`,
        {
          method: "GET",
          headers: this.getHeaders(token),
          credentials: "include",
  ...
  async getTrafficAnalytics(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/analytics/stores/${storeId}/traffic?${queryParams}`,
        {
          method: "GET",
          headers: this.getHeaders(token),
          credentials: "include",
