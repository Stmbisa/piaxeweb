...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Revolutionizing payments in Uganda with escrow protection, POS-free solutions, and comprehensive business tools.",
    images: [
      {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Piaxe",
              "description": "Secure payment system optimized for low trust environments with escrow protection, POS-free payments, and business tools.",
              "url": "https://piaxe.com",
              ...
              "offers": [
                ...
                },
                {
                  "@type": "Offer",
                  "name": "Payment API",
                  "description": "Integrate secure payment processing into your applications"
                }
              ]
            })
          }}
